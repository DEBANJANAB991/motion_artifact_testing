...
#SBATCH --output=results/logs/UNet.out      # Standard output log file (%j expands to job ID)
#SBATCH --error=results/logs/UNet.err       # Standard error log file (%j expands to job ID)
...
#python3 add_motion_artifacts_2d.py
#python3 dicom_to_sinogram.py
#python3 dicom_to_sinogram_test.py
#python3 add_motion_artifacts_test.py
#python3 sinogram_to_dicom.py
...
#python3 visualise_dicom.py
#python3 compare_models.py
#python3 testreco.py
#python3 testsinogram.py
#python3 dicomdump.py
#python3 geometry_search.py
#python3 add_motion_artifacts_test_2d.py
#python3 test_MR_LKV.py
#python3 2D_to_3D.py