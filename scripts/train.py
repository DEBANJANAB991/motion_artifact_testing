#!/usr/bin/env python3
"""
Full training script for MR_LKV and baselines (UNet, RepLKNet, SwinIR, Restormer)
...
def main():
    ...
    if args.model == "unet":
        ...
        model = SwinIRWrapper(img_size=512, window_size=8, in_chans=1, out_chans=1, depths=[4,4,4,4], embed_dim=64, num_heads=[2,2,2,2], use_checkpoint=False).to(device)
